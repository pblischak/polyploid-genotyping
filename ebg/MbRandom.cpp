// Modified by Paul Blischak (PDB) for ebg starting Septermber 2016.
...
double MbRandom::TwoCatPoissBinomPdf(int size1, int size2, int x, double prob1, double prob2){
  return exp(lnTwoCatPoissBinomPdf(size1, size2, x, prob1, prob2));
}
